  ...
  return (
    <header className="flex items-center justify-between border-b border-white/10 px-4 py-4 sm:px-8">
      ...
      <div className="flex items-center gap-4">
        <button aria-label="Notifications" className="rounded-lg border border-white/10 p-2 text-slate-300">
          <Bell className="h-4 w-4" />
        </button>
        <button aria-label="AI system status" className="rounded-lg border border-white/10 p-2 text-slate-300">
